...
from nlp_tasks.absa.mining_opinions.allennlp_bert_supporting_position.modeling_supporting_position import BertModel
...
class BertEmbedder(TokenEmbedder):
    ...
    def forward(self,
                ...
                token_type_ids: torch.LongTensor = None, position_ids=None) -> torch.Tensor:
        """
        Parameters
        ----------
        input_ids : ``torch.LongTensor``
        ...
        all_encoder_layers, _ = self.bert_model(input_ids=util.combine_initial_dims(input_ids),
                                                ...
                                                position_ids=util.combine_initial_dims(position_ids))
...
@TokenEmbedder.register("bert-pretrained-supporting-position")
