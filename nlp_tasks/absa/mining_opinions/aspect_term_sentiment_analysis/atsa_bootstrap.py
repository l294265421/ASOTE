...
from nlp_tasks.absa.mining_opinions.aspect_term_sentiment_analysis import atsa_train_templates as templates


parser = argparse.ArgumentParser()
parser.add_argument('--current_dataset', help='dataset name', default='triplet_rest14', type=str)
parser.add_argument('--task_name', help='task name', default='atsa', type=str)
parser.add_argument('--data_type', help='task name', default='common', type=str)
parser.add_argument('--model_name', help='model name', default='AtsaLSTM', type=str)
...
parser.add_argument('--train_bert', default=True, type=argument_utils.my_bool)
