...
parser.add_argument('--task_name', help='task name', default='ote', type=str)
...
if model_name in ['NerLstm']:
    template = templates.NerLstmForOTE(configuration_for_this_repeat)
elif model_name in ['NerBert']:
    template = templates.NerBertForOTE(configuration_for_this_repeat)
else:
