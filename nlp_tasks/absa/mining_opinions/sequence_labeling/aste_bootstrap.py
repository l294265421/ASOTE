...
parser.add_argument('--task_name', help='task name', default='aste', type=str)
...
parser.add_argument('--polarities', default='positive,neutral,negative', type=str) # POS,NEU,NEG
...
parser.add_argument('--validation_metric', help='validation metric for early stopping',
                    default='+opinion_sentiment_f1', type=str, choices=['+f1',
...
if model_name in ['AsteTermBiLSTM']:
    template = templates.AsteTermBiLSTM(configuration_for_this_repeat)
